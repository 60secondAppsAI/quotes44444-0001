              ...
              <div v-if="activeTab === 'Details'" class="tab-panel">
                <div class="details-section">
                  ...
                  <div class="info-grid">
                    ...
                    <div class="info-item">
                      <span class="info-label">RegistrationDate</span>
                      <span class="info-value">{{ userData.registrationDate || 'N/A' }}</span>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                      <span class="info-label">PasswordHash</span>
                      <span class="info-value">{{ userData.passwordHash || 'N/A' }}</span>
                    </div>
                    <div class="info-item">
