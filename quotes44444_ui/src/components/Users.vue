        ...
        >
          ...
          <div class="user-info">
            ...
            <div class="user-metadata">
              ...
              <div class="metadata-item">
                <span class="metadata-label">PasswordHash:</span>
                <span class="metadata-value">{{ user.passwordHash || 'N/A' }}</span>
              </div>
              <div class="metadata-item">
              ...
              <div class="metadata-item">
                <span class="metadata-label">RegistrationDate:</span>
                <span class="metadata-value">{{ user.registrationDate || 'N/A' }}</span>
              </div>
        ...
        <table class="users-table">
          <thead>
            <tr>
              ...
              <th @click="handleSort('passwordHash')" class="sortable-header">
                PasswordHash {{ getSortIcon('passwordHash') }}
              </th>
              <th @click="handleSort('email')" class="sortable-header">
                Email {{ getSortIcon('email') }}
              </th>
              <th @click="handleSort('registrationDate')" class="sortable-header">
                RegistrationDate {{ getSortIcon('registrationDate') }}
              </th>
            ...
            <tr v-for="user in filteredUsers" :key="user.userId" class="user-row">
                ...
                <div class="$field.name.camel-info-table">
                  <span class="$field.name.camel-name-table">{{ user.username }}</span>
                              ...
                              <td class="$field.name.camel-cell">
                <div class="$field.name.camel-info-table">
                  <span class="$field.name.camel-name-table">{{ user.passwordHash }}</span>
                </div>
              </td>
                              <td class="$field.name.camel-cell">
                <div class="$field.name.camel-info-table">
                  <span class="$field.name.camel-name-table">{{ user.email }}</span>
                              ...
                              <td class="$field.name.camel-cell">
                <div class="$field.name.camel-info-table">
                  <span class="$field.name.camel-name-table">{{ user.registrationDate }}</span>
                </div>
              </td>
